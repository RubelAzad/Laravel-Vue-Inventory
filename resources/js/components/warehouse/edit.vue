                ...
                <div class="col-lg-12">
                  <div class="login-form">
                    <div class="text-center">
                      <h1 class="h4 text-gray-900 mb-4">Edit warehouse</h1>
                    </div>
                    <div class="card-body">
                    <form class="user" @submit.prevent="warehouseUpdate" enctype="multipart/form-data">
...
export default {
    ...
    methods: {
        ...
        warehouseUpdate(){
            let id = this.$route.params.id
            axios.patch('/api/warehouse/'+id,this.form)
            .then(() => {
